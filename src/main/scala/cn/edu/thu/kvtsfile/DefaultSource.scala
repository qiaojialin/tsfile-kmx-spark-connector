...
import cn.edu.thu.kvtsfile.io.HDFSInputStream
import cn.edu.thu.kvtsfile.qp.Executor
import cn.edu.thu.kvtsfile.qp.common.{SQLConstant, SparkConstant}
...
class DefaultSource extends FileFormat with DataSourceRegister{
  ...
  override def buildReader(
    ...
    (file: PartitionedFile) => {
      ...
      val queryConfigs = Converter.toQueryConfigs(in, requiredSchema, filters, DefaultSource.keys.toArray,
      ...
      new Iterator[InternalRow] {
        ...
        override def next(): InternalRow = {
          ...
          requiredSchema.foreach((field: StructField) => {
            ...
            } else if (DefaultSource.keys.contains(field.name)) {
